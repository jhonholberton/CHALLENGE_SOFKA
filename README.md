...
se puede dar inicio al juego de dos maneras teniendo un usuario registrado e iniciando sesion o registrando un nuevo usuario, tenga en cuenta dar todos los datos solicitados para que el juego lo deje registrar.
